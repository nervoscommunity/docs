---
id: 0020-ckb-consensus-protocol
title: CKB Consensus Protocol
sidebar_label: 20：CKB Consensus Protocol
---
...
The adjusted hash rate estimation, denoted as *HPS<sub>i</sub>* is computed by applying a dampening factor τ to the last epoch’s actual hash rate ![1559068235154](/img/rfcs/0020/1559068235154.png). The actual hash rate is calculated as follows:

![1559064934639](/img/rfcs/0020/1559064934639.png)
...
![1559068266162](/img/rfcs/0020/1559068266162.png) is computed by dividing the expected total hash operations with the duration *L<sub>i</sub>*

Now we apply the dampening filter:

![1559064108898](/img/rfcs/0020/1559064108898.png)
...
![1559064685714](/img/rfcs/0020/1559064685714.png)

namely

![1559064995366](/img/rfcs/0020/1559064995366.png)

If we join this equation with Equation (2), we can solve for *dp*:

![1559065017925](/img/rfcs/0020/1559065017925.png)
...
![1559065197341](/img/rfcs/0020/1559065197341.png)



where ![1559065416713](/img/rfcs/0020/1559065416713.png)is the number of main chain blocks in the next epoch, if our only goal is to achieve *o*<sub>ideal</sub> and *L*<sub>ideal</sub> .

By joining Equation (4) and (5), we can solve for ![1559065488436](/img/rfcs/0020/1559065416713.png):

![1559065517956](/img/rfcs/0020/1559065517956.png)



Now we can apply the upper and lower bounds to![1559065488436](/img/rfcs/0020/1559065416713.png) and get *C*<sub>*i*+1,m</sub>:

![1559065670251](/img/rfcs/0020/1559065670251.png)
...
First, we introduce an adjusted orphan rate estimation ![1559065968791](/img/rfcs/0020/1559065968791.png), which will be used to compute the target:

![1559065997745](/img/rfcs/0020/1559065997745.png)



Using ![1559065968791](/img/rfcs/0020/1559065968791.png) instead of *o*<sub>ideal</sub> prevents some undesirable situations when the main chain block number reaches the upper or lower bound. Now we can compute *T*<sub>*i*+1</sub>:

![1559066101731](/img/rfcs/0020/1559066101731.png)

where ![1559066131427](/img/rfcs/0020/1559066131427.png) is the total hashes, ![1559066158164](/img/rfcs/0020/1559066158164.png)is the total number of blocks.

The denominator in Equation (7) is the number of hashes required to find a block.

Note that if none of the edge cases are triggered, such as ![1559066233715](/img/rfcs/0020/1559066233715.png)![1559066249700](/img/rfcs/0020/1559066249700.png) or ![1559066329440](/img/rfcs/0020/1559066329440.png)  , we can combine Equations (2), (6), and (7) and get:

![1559066373372](/img/rfcs/0020/1559066373372.png)
...
![1559066526598](/img/rfcs/0020/1559066526598.png)
