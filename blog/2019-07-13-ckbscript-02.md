...
原文：https://xuejie.space/2019_07_13_introduction_to_ckb_script_programming_script_basics/

**本篇翻译已原文2019-12-25的内容为准**
...
现在您已经成功地在 CKB 上部署了一个 JavaScript 引擎，并在 CKB 上运行基于 JavaScript 的脚本！你可以在这里尝试任何JavaScript代码。
